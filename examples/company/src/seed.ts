/**
 * The administrator, the pages and the content (SPEC.md §50, §79, §85).
 *
 ...
 * before the account exists: an administrator whose password went nowhere is one
...
export const seed = async (app: Application): Promise<void> => {
  ...
  // The address, never the password: it is in `.env`, under ASSEMORA_SEED_PASSWORD.
