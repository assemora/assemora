 ...
 * the generated SDK types it, and an agent asking `assemora.describe` is told the
 * same thing. A field left out here is simply not editable — which is how a column
 * stays out of a form without a second schema being written to say so.
 */
