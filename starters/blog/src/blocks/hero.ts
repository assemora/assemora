 ...
 * and it lives in `app/blocks/hero.tsx` — so the site can be redesigned without this
 * file changing, and the builder can offer a block before anybody has styled it.
 */
